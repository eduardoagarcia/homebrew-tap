class Shef < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/yourusername/shef/releases/download/v0.1.3/shef_darwin_amd64.tar.gz"
    sha256 "1dfb46b7b4fd830693b28ae92a89fdcd95865df75663ea35bca057194da3d0c4"
  # Apple Silicon
  else
    url "https://github.com/yourusername/shef/releases/download/v0.1.3/shef_darwin_arm64.tar.gz"
